...
下载器在 `apps/downloader/` 下，是一个明确隔离的本地 CLI，不会把下载功能塞回主 Web UI。
...
这个项目现在已经不是一个“接口 demo”。

它更像一个刚刚长出工作流骨架的产品: 有真实搜索，有本地沉淀，有整理动作，有登录态维护，也有后续继续打磨体验的空间。README 的工作，不只是告诉别人怎么跑起来，更是告诉别人为什么它值得被继续做下去。
